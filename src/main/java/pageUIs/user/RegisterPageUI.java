...
public class RegisterPageUI {
	...
	public static final String LASTTNAME_ERROR_MESSAGE = "xpath=//span[@id='LastName-error']";
	...
	public static final String LASTTNAME_TEXTBOX= "xpath=//input[@id='LastName']";
	...
	public static final String WRONG_EMAIL_MESSAGE = "xpath=//div[contains(@class,'message-error')]//li";
